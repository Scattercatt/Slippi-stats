...
import { SlpInputSource, openSlpFile, iterateEvents, closeSlpFile, getGameEnd, getMetadata } from './utils/slpReader.esm.js';
...
class SlippiGame {
  ...
  getWinners() {
    ...
    const firstPosition = placements.find(placement => (placement == null ? void 0 : placement.position) === 0);
    ...
    if (settings != null && settings.isTeams) {
      var _settings$players$fin;

      const winningTeam = (_settings$players$fin = settings.players.find(({
        playerIndex
      }) => playerIndex === firstPosition.playerIndex)) == null ? void 0 : _settings$players$fin.teamId;
      return placements.filter(placement => {
        var _settings$players$fin2;

        const teamId = (_settings$players$fin2 = settings.players.find(({
          playerIndex
        }) => playerIndex === placement.playerIndex)) == null ? void 0 : _settings$players$fin2.teamId;
